...
public class UserController {
        ...
        protected static final String URI_VALUE = "home/users";
        ...
        @RequestMapping(value = URI_VALUE_USER, method = RequestMethod.GET, produces = "application/json")
        public ResponseEntity<List<Document>> findUser(@PathVariable("username") final String username, @PathVariable("password") final String password) {
            ...
            return new ResponseEntity<List<Document>>(userService.findUser(username, password), HttpStatus.FOUND);
        }
